package com.sticker.kevin.Storys.adapter;
...
import com.sticker.kevin.Storys.recycler.ImageViewHolder;
 ...
 */
public class WAImageAdapter extends RecyclerView.Adapter<ImageViewHolder> {
    ...
    @Override
    public ImageViewHolder onCreateViewHolder( //cuando se esten cargando las imagenes, se colocara esta imagen
